...
- ~~Try the book "Eigo Nodo 50 no Method"~~
  - It introduces an original method called "throat pronunciation" with its own phonetic symbols. Compared to standard phonetic symbols, the same sound is marked differently, which was confusing.
...
2. Look up the meaning of every unknown word
3. Read the whole article again
4. Repeat step 3 until I can finish within a set time
